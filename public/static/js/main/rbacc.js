    ...
    var Controller = {
            ...
            ********************************************/
            ...
            useraccesssave:function(){
                var _self=this,zTree=this.treeinit();
                // 加载layui 公共配置文件
                layui.config({
                ...
                layui.use(['element','form'], function(){
                    ...
                    form.on('submit(userauth)', function(data){
                          Main.api.form(_self.config.options.auth_user,_self.gettreedata(zTree));
                          return false;
                    });
                });        
            },
            ...
            treeinit:function(){
                ...
                zTree = $.fn.zTree.init($("#first_tree"),setting, treeNodes); debugger;
                ...
                ************/
                operate:{
                        ...
                        auth:function(config,data,obj){
                            Main.api.open(config.options['auth_'+config.colum.id]+'?'+config.colum.key+'='+data[config.colum.key],'设置用户权限',{},function(){
                            },function(formobj){
                            });
                        },
